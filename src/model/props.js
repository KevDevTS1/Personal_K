...
const SIGMA_TABLE = {
  ...
  "baloncesto|pra (puntos+rebotes+asistencias)": 8.5,
  "baloncesto|asistencias-equipo": 4.1,
  "futbol|goles partido": 1.35,
  "futbol|goles (jugador)": 0.42,
  "futbol|asistencias (jugador)": 0.35,
  "futbol|corners partido": 2.35,
  "futbol|tarjetas partido": 1.65,
  "futbol|tiros (jugador)": 0.55,
  "futbol|goles 1t": 0.68,
  "futbol|goles local equipo": 0.45,
  "beisbol|hits-equipo": 1.9,
  "beisbol|strikeouts lanzador": 1.8,
  "beisbol|carreras equipo": 1.45,
  "beisbol|dobles (bateador)": 0.55,
  "beisbol|rbi (bateador)": 0.62,
  "beisbol|bases totales": 1.15,
  "beisbol|hits+runs+rbi": 1.25,
  "beisbol|carreras bateador": 0.32,
